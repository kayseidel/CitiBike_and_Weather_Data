# make 4-hour chunks for weather times throughout the day:
# 12:00AM-3:00AM, 4:00AM-7:00AM, 8:00AM-11:00AM, 12:00PM-3:00PM, 4:00PM-7:00PM, and 8:00PM-11:00PM
# add the chunks as a new field in between the date and the weather
# print: date | timeChunk | minTemp | maxTemp | rain

BEGIN {
    FS = "|"  # input field separator
    OFS = "|" # output field separator
    file = "./weather2014rain" # input file
